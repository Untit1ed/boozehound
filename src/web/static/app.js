const app = Vue.createApp({
   ...
   methods: {
      ...
      getQueryParams() {
         ...
         this.filters.sale_only = params.get('sale_only') === 'true';
      },
      updateQueryParams() {
         ...
         if(this.filters.sale_only) {
            params.set('sale_only', this.filters.sale_only);
         }
      ...
      get_image: (sku) => `/image/height400px/${sku}.jpg`,
